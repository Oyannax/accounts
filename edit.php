...
<body>
    ...
    <div class="container">
        <section class="card mb-4 rounded-3 shadow-sm">
            ...
            <div class="card-body">
                <?php $transac = getAllFromId($_GET['id']) ?>
                <form action="action.php" method="POST">
                    <div class="mb-3">
                        <label for="name" class="form-label">Nom de l'opération *</label>
                        <input type="text" class="form-control" name="name" id="name" value="<?= $transac['name'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="date" class="form-label">Date *</label>
                        <input type="date" class="form-control" name="date" id="date" value="<?= $transac['date_transaction'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="amount" class="form-label">Montant *</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="amount" id="amount" value="<?= $transac['amount'] ?>" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="category" id="category">
                            <option value="<?= $transac['id_category'] ?>" selected><?= $transac['category_name'] ?></option>
                    ...
                    <input type="hidden" name="id" value="<?= $transac['id_transaction'] ?>">
